  ...
  <div>
    ...
    <main>
      <div id="card">
        ...
        <div id="card__note">By subscribing you agree to our Use of Service. Your payment method will be charged with ${{ checkedPlan.price }} and you’ll have access to all locked features until {{ expiredDate }}.</div>
